...
public class NMS_1_19_R1 extends NbtManager {
    @Override
    public List<String> getWands(ItemStack item) {
        net.minecraft.world.item.ItemStack i = CraftItemStack.asNMSCopy(item);
        NBTTagCompound nbt = null;
        try {
            nbt = (NBTTagCompound) i.getClass().getMethod("v").invoke(i);
        } catch (IllegalAccessException | InvocationTargetException | NoSuchMethodException e) {
            e.printStackTrace();
        }
        List<String> list = new ArrayList<>();
        try {
            if ((boolean) nbt.getClass().getMethod("e", String.class).invoke(nbt, "PlantingWand")) {
                NBTTagList nlist = (NBTTagList) nbt.getClass().getMethod("c", String.class, int.class).invoke(nbt, "PlantingWand", 8);
                for (NBTBase n : nlist) {
    ...
    public ItemStack addWand(ItemStack item, String buff) {
        ...
        try {
            if ((boolean) nbt.getClass().getMethod("e", String.class).invoke(nbt, "PlantingWand")) {
                nlist = (NBTTagList) nbt.getClass().getMethod("c", String.class, int.class).invoke(nbt, "PlantingWand", 8);
                nlist.add(NBTTagString.a(buff));
            } else {
                nlist = new NBTTagList();
                nlist.add(NBTTagString.a(buff));
            }
            nbt.getClass().getMethod("a", String.class, List.class).invoke(nbt, "PlantingWand", nlist);
    ...
    public ItemStack removeWand(ItemStack item, String buff) {
        ...
        try {
            ...
            nbt.getClass().getMethod("a", String.class, List.class).invoke(nbt, "PlantingWand", list);
            i.getClass().getMethod("c", NBTTagCompound.class).invoke(i, nbt);
        } catch (IllegalAccessException | InvocationTargetException | NoSuchMethodException e) {
            e.printStackTrace();
        }
